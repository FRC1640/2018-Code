...
public class ToScaleMidCommand extends AutonScript {

	public ToScaleMidCommand(IRobotContext robotContext) {
		addCommand("lift", new PlacerPresetCommand(robotContext, PlacerPreset.ScaleMid));
