...
public class TurnToDirectionVisionRight extends TurnToDirection {
	
	protected VisionServer visionServer;
	protected double visionAngleBuffer;
	protected boolean isLeft;
	
	public TurnToDirectionVisionRight(VisionServer visionServer, DirectionalStrategy directionalStrat, IGyro gyro, double angleBuffer, double secondsInBuffer, 
	...
	public TurnToDirectionVisionRight(VisionServer visionServer, DirectionalStrategy directionalStrat, IGyro gyro, 
