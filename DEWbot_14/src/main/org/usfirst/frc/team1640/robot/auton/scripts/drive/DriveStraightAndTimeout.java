...
public class DriveStraightAndTimeout extends AutonScript {
	
	public DriveStraightAndTimeout(IRobotContext robotContext, double distanceInInches, double angle, double maxDrive, double timeoutInSeconds) {
		...
		addCommand("drive1", new DriveAlongTrapezoidalCurveAndTimeout(driveTrain, myStrat, distanceInInches, angle-gyro.getYaw(), maxDrive, timeoutInSeconds));
