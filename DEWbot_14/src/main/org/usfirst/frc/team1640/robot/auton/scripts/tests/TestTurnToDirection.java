package main.org.usfirst.frc.team1640.robot.auton.scripts.tests;
...
public class TestTurnToDirection extends AutonScript {

	public TestTurnToDirection(IRobotContext robotContext) {
		...
		addCommand("turn-to-direction", new TurnToDirection(sunflower, gyro, 90, 3, 0.1, 10));
		addCommand("wait-turn-to-direction", new WaitCommand(getCommand("turn-to-direction")));
		addCommand("print", new PrintCommand("Finished Turning"));
	}
